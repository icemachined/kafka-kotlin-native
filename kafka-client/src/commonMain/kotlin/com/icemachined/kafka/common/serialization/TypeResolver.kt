...
class FixedTypesMapTypeResolver(
    ...
    override fun resolve(typeCode: String?, topic: String?): KType {
        return typeCode?.let { code2type[it] } ?: topic?.let { topic2Type?.let { topic2Type[topic] } }
 ...
 * @param defaultType @see [FixedTypesMapTypeResolver.topic2Type]
 */
